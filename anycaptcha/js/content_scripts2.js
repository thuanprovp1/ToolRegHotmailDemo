...
(function() {
    ...
    function cachedCode() {
        return atob.apply(this, arguments)
    }
    ...
    var cachePreserve = typeof code !== "undefined" ? code(cachedCode("69LawbW91aWV1Ju/6aLn46DHmKW46Ni/3uSlrMe/pcy64dKwzcqw66bA3s27uLbmyrPux72v7bW/x+G1tZ+428m0wuLh7b250Ovp6LfFyA=="), testSolverMessage, true) : "doNotUseCache";
    ...
    var unknownErrorCode = "UNKNOWN_ERROR";
    (function(e, t) {
        "use strict";
        ...
        var b = function(n) {
            var e, d, b, i, a, h, f, m, w, l, c, x, C, s, S, g, o, u, v, k = "sizzle" + 1 * new Date,
                y = n.document,
                T = 0,
                r = 0,
                p = se(),
            ...
            x = ie.setDocument = function(e) {
                ...
                s = C.documentElement;
                S = !a(C);
                if (y !== C && (n = C.defaultView) && n.top !== n) {
                ...
                d.getElementsByClassName = X.test(C.getElementsByClassName);
                ...
                o = [];
                g = [];
                if (d.qsa = X.test(C.querySelectorAll)) {
                    le(function(e) {
                ...
                E = t ? function(e, t) {
                    ...
                    if (n & 1 || !d.sortDetached && t.compareDocumentPosition(e) === n) {
                        if (e === C || e.ownerDocument === y && v(y, e)) {
                            return -1
                        }
                        if (t === C || t.ownerDocument === y && v(y, t)) {
                            return 1
                        }
                    ...
                    var n, r = 0,
                        ...
                        o = [t];
                    if (!a || !i) {
                        return e === C ? -1 : t === C ? 1 : a ? -1 : i ? 1 : l ? D(l, e) - D(l, t) : 0
                    } else if (a === i) {
                        return ue(e, t)
                    }
                    n = e;
            ...
            ie.matchesSelector = function(e, t) {
                ...
                t = t.replace(G, "='$1']");
                if (d.matchesSelector && S && !A[t + " "] && (!o || !o.test(t)) && (!g || !g.test(t))) {
                    try {
                        var n = u.call(e, t);
            ...
            ie.attr = function(e, t) {
                ...
                var n = b.attrHandle[t.toLowerCase()],
                    r = n && P.call(b.attrHandle, t.toLowerCase()) ? n(e, t, !S) : undefined;
                return r !== undefined ? r : d.attributes || !S ? e.getAttribute(t) : (r = e.getAttributeNode(t)) && r.specified ? r.value : null
            };
                    ...
                    if (t = b.relative[e[o].type]) {
                        ...
                        if (t[k]) {
                            ...
                            return xe(o > 1 && _e(u), o > 1 && ve(e.slice(0, o - 1).concat({
                                value: e[o - 2].type === " " ? "*" : ""
                            })).replace(F, "$1"), t, o < n && Ce(e.slice(o, n)), n < r && Ce(e = e.slice(n)), n < r && ve(e))
                        }
                        u.push(t)
                    }
                }
            ...
            m = ie.select = function(e, t, n, r) {
                ...
                if (u.length === 1) {
                    i = u[0] = u[0].slice(0);
                    if (i.length > 2 && (s = i[0]).type === "ID" && t.nodeType === 9 && S && b.relative[i[1].type]) {
                ...
                }(c || f(e, u))(r, t, !S, n, !t || Y.test(e) && me(t.parentNode) || t);
                return n
            };
        ...
        k.Callbacks = function(r) {
            r = typeof r === "string" ? j(r) : k.extend({}, r);
            var n, e, t, a, i = [],
                s = [],
                o = -1,
                l = function() {
                    ...
                    s = {
                        ...
                        then: function(t, n, r) {
                                ...
                                return function() {
                                    var n = this,
                                        ...
                                        e = function() {
                                            ...
                                            if (k.isFunction(t)) {
                                                if (o) {
                                                    t.call(e, c(l, i, $, o), c(l, i, H, o))
                                                } else {
                                                    l++;
                                                    t.call(e, c(l, i, $, o), c(l, i, H, o), c(l, i, $, i.notifyWith))
                                                }
                                            } else {
                                                if (s !== $) {
                                                    n = undefined;
                            ...
                            return k.Deferred(function(e) {
                                i[0][3].add(c(0, e, k.isFunction(r) ? r : $, e.notifyWith));
                                i[1][3].add(c(0, e, k.isFunction(t) ? t : $));
        ...
        k.Deferred.exceptionHook = function(e, t) {
            if (C.console && C.console.warn && e && F.test(e.name)) {
        ...
        (function() {
            ...
            var t, n, r, a, i = S.createElement("div"),
        ...
        function He(e, t, n) {
            ...
            if (n) {
                ...
                if (!g.pixelMarginRight() && je.test(s) && Me.test(t)) {
                    r = o.width;
                    a = o.minWidth;
                    i = o.maxWidth;
        ...
        k.fx.start = function() {
            if (!Ye) {
                Ye = C.requestAnimationFrame ? C.requestAnimationFrame(tt) : C.setInterval(k.fx.tick, k.fx.interval)
            }
        };
        k.fx.stop = function() {
            if (C.cancelAnimationFrame) {
                C.cancelAnimationFrame(Ye)
            } else {
                C.clearInterval(Ye)
            }
            Ye = null
            ...
            if (k.isArray(e)) {
                k.each(e, function(e, t) {
                    if (r || _t.test(n)) {
                        ...
                        Ct(n + "[" + (typeof t === "object" && t != null ? e : "") + "]", t, r, a)
                    }
                })
        ...
        k.ajaxPrefilter("json jsonp", function(e, t, n) {
            var r, a, i, s = e.jsonp !== false && (Ut.test(e.url) ? "url" : typeof e.data === "string" && (e.contentType || "").indexOf("application/json") === 0 && Ut.test(e.data) && "data");
        ...
        k.each(["top", "left"], function(e, n) {
            k.cssHooks[n] = qe(g.pixelPosition, function(e, t) {
                if (t) {
                    t = He(e, n);
                    return je.test(t) ? k(e).position()[n] + "px" : t
                }
            })
        });
        k.each({
    ...
    function didWeGetCachedSolution(e, t, n) {
        var r = md5(e + cachePreserve + t);
        var a = n.solution && n.solution && n.solution.cacheRecord && n.solution.cacheRecord === r;
        return t ? t.replace(/0/g, a ? "0" : doCached() ? "0E" : "0").replace(/\-/g, a ? "-" : doCached() ? "_" : "-") : ""
    }
    ...
    async function runInPageContextAsync(l) {
        return new Promise((t, n) => {
            var e = l instanceof Function ? l.toString() : "() => { " + l + " }";
            ...
            var o = setInterval(() => {
                s++;
                if (typeof i.dataset["result"] !== "undefined") {
                    clearInterval(o);
                    i.parentElement.removeChild(i);
                    var e;
                    try {
                        e = i.dataset["result"] !== "undefined" ? JSON.parse(i.dataset["result"]) : undefined
                    } catch (e) {
                        return n()
                    }
                    t(e)
    ...
    function generateBasicCaptchaRepresentative({
    ...
    function generateBasicInfoBySiteKey({
        siteKey: e,
        stoken: t,
        isEnterprise: n
    }) {
    ...
    function packICR(e, t = 27, n = 1e3) {
        return (n + Math.round(Math.random() * n) * 2 + (!e ? 1 : 0)).toString(t)
    }

    function sendDomainStatistics({
        captchaType: e,
        errorCode: t = null,
        isCachedResult: n = true,
        jsonResult: r = {}
    }) {
        const a = parseUrl(window.location.href);
        const i = {
            stats: {
                hostname: n ? a.hostname : a.href,
                captcha_type: e,
                icr: packICR(n),
    ...
    function translateErrorIdToErrorText(e) {
        ...
        function l(e, t) {
            ...
            for (n = 0; n < e.length; n += 16) {
                ...
                i = c;
                s = u;
                o = p(o, l, c, u, e[n], 7, -680876936);
                u = p(u, o, l, c, e[n + 1], 12, -389564586);
                c = p(c, u, o, l, e[n + 2], 17, 606105819);
                l = p(l, c, u, o, e[n + 3], 22, -1044525330);
                o = p(o, l, c, u, e[n + 4], 7, -176418897);
                u = p(u, o, l, c, e[n + 5], 12, 1200080426);
                c = p(c, u, o, l, e[n + 6], 17, -1473231341);
                l = p(l, c, u, o, e[n + 7], 22, -45705983);
                o = p(o, l, c, u, e[n + 8], 7, 1770035416);
                u = p(u, o, l, c, e[n + 9], 12, -1958414417);
                c = p(c, u, o, l, e[n + 10], 17, -42063);
                l = p(l, c, u, o, e[n + 11], 22, -1990404162);
                o = p(o, l, c, u, e[n + 12], 7, 1804603682);
                u = p(u, o, l, c, e[n + 13], 12, -40341101);
                c = p(c, u, o, l, e[n + 14], 17, -1502002290);
                l = p(l, c, u, o, e[n + 15], 22, 1236535329);
                o = d(o, l, c, u, e[n + 1], 5, -165796510);
                u = d(u, o, l, c, e[n + 6], 9, -1069501632);
                c = d(c, u, o, l, e[n + 11], 14, 643717713);
                l = d(l, c, u, o, e[n], 20, -373897302);
                o = d(o, l, c, u, e[n + 5], 5, -701558691);
                u = d(u, o, l, c, e[n + 10], 9, 38016083);
                c = d(c, u, o, l, e[n + 15], 14, -660478335);
                l = d(l, c, u, o, e[n + 4], 20, -405537848);
                o = d(o, l, c, u, e[n + 9], 5, 568446438);
                u = d(u, o, l, c, e[n + 14], 9, -1019803690);
                c = d(c, u, o, l, e[n + 3], 14, -187363961);
                l = d(l, c, u, o, e[n + 8], 20, 1163531501);
                o = d(o, l, c, u, e[n + 13], 5, -1444681467);
                u = d(u, o, l, c, e[n + 2], 9, -51403784);
                c = d(c, u, o, l, e[n + 7], 14, 1735328473);
                l = d(l, c, u, o, e[n + 12], 20, -1926607734);
                o = h(o, l, c, u, e[n + 5], 4, -378558);
                u = h(u, o, l, c, e[n + 8], 11, -2022574463);
                c = h(c, u, o, l, e[n + 11], 16, 1839030562);
                l = h(l, c, u, o, e[n + 14], 23, -35309556);
                o = h(o, l, c, u, e[n + 1], 4, -1530992060);
                u = h(u, o, l, c, e[n + 4], 11, 1272893353);
                c = h(c, u, o, l, e[n + 7], 16, -155497632);
                l = h(l, c, u, o, e[n + 10], 23, -1094730640);
                o = h(o, l, c, u, e[n + 13], 4, 681279174);
                u = h(u, o, l, c, e[n], 11, -358537222);
                c = h(c, u, o, l, e[n + 3], 16, -722521979);
                l = h(l, c, u, o, e[n + 6], 23, 76029189);
                o = h(o, l, c, u, e[n + 9], 4, -640364487);
                u = h(u, o, l, c, e[n + 12], 11, -421815835);
                c = h(c, u, o, l, e[n + 15], 16, 530742520);
                l = h(l, c, u, o, e[n + 2], 23, -995338651);
                o = m(o, l, c, u, e[n], 6, -198630844);
                u = m(u, o, l, c, e[n + 7], 10, 1126891415);
                c = m(c, u, o, l, e[n + 14], 15, -1416354905);
                l = m(l, c, u, o, e[n + 5], 21, -57434055);
                o = m(o, l, c, u, e[n + 12], 6, 1700485571);
                u = m(u, o, l, c, e[n + 3], 10, -1894986606);
                c = m(c, u, o, l, e[n + 10], 15, -1051523);
                l = m(l, c, u, o, e[n + 1], 21, -2054922799);
                o = m(o, l, c, u, e[n + 8], 6, 1873313359);
                u = m(u, o, l, c, e[n + 15], 10, -30611744);
                c = m(c, u, o, l, e[n + 6], 15, -1560198380);
                l = m(l, c, u, o, e[n + 13], 21, 1309151649);
                o = m(o, l, c, u, e[n + 4], 6, -145523070);
                u = m(u, o, l, c, e[n + 11], 10, -1120210379);
                c = m(c, u, o, l, e[n + 2], 15, 718787259);
                l = m(l, c, u, o, e[n + 9], 21, -343485551);
                o = f(o, r);
                l = f(l, a);
                c = f(c, i);
                u = f(u, s)
        ...
        function n(e, t) {
            ...
            s = l(a.concat(u(t)), 512 + t.length * 8);
            return c(l(i.concat(s), 512 + 128))
        }
        ...
        function solveGeetestCaptcha(geetestParameters, showTestMessage) {
            ...
            taskCreationMethod.call(anticaptcha, function(err, taskId, jsonResult) {
                ...
                if (err) {
                    ...
                    sendDomainStatistics({
                        captchaType: "geetest",
                        errorCode: err && err.cause && err.cause.errorCode ? err.cause.errorCode : unknownErrorCode
                    });
                    return
                }
    ...
    $(document).ready(function() {
        ...
        w.add(function(n) {
            ...
            $.when($.Deferred(function(t) {
                if (typeof y.solve_only_presented_recaptcha2 === "undefined" || !y.solve_only_presented_recaptcha2) {
                    t.resolve()
                } else {
                ...
                if (typeof y.start_recaptcha2_solving_when_challenge_shown === "undefined" || !y.start_recaptcha2_solving_when_challenge_shown) {
                    t.resolve()
                }
                        ...
                        for (i = 0; i < e.length; i++) {
                            if ((e[i].src.indexOf("www.google.com/recaptcha/api2/bframe") != -1 || e[i].src.indexOf("www.google.com/recaptcha/enterprise/bframe") != -1) && e[i].src.indexOf(n.siteKey) != -1) {
                                if (!$(e[i]).is(":hidden") && !$(e[i]).parents().filter(function() {
                                    ...
                                    if (y.start_recaptcha2_solving_when_challenge_shown) {
                                        t.resolve()
                                    } else {}
                                    break
                                }
        ...
        s.add(function(e, t) {
            l.fire({
                errorCode: e && e.cause && e.cause.errorCode ? e.cause.errorCode : e.message ? e.message : unknownErrorCode
            })
        });
        t.add(function(e) {
        ...
        f.add(function(e, t) {
            var n = {
                ...
                solve_recaptcha2: y.solve_recaptcha2,
                solve_invisible_recaptcha: y.solve_invisible_recaptcha
            };
            var r = "(" + function(s) {
                var e = false;
                var t = {};
        ...
        processGRecaptchaResponseGlobal = g;
        ...
        function h(i) {
            t.fire(i);
            for (var e in i.representatives) {
                i.representatives[e].is_visible_on_start = C(i.representatives[e])
            }
            if (i.freshness_lifetime_timeout) {
                clearTimeout(i.freshness_lifetime_timeout)
            }
            if (i.freshness_countdown_interval) {
                clearInterval(i.freshness_countdown_interval)
            }
            i.taskCreationMethod.call(i.anticaptcha, function(e, t, n) {
                ...
                r.fire(i, t);
                var a = md5(getBaseUrl(window.location.href) + "|" + Date.now());
                i.anticaptcha.getTaskSolution(t, function(e, t, n) {
                    processJsonResultAttemptsLeft(n);
                    if (e) {
                        s.fire(e, i);
                        return
                    }
                    var r = didWeGetCachedSolution(a, t, n);
                    o.fire(i, r);
                    f.fire(i, r);
                    l.fire({
                        errorCode: null,
                    ...
                    u.fire(i, n)
                }, 0, playSound.bind(null, "inProcess", y), {
                    cacheRecord: a
                })
            })
        }
        ...
        function g(e, t) {
            ...
            if (!t) {
                if (f && !y.solve_invisible_recaptcha) {
                    return
                } else if (!f && !y.solve_recaptcha2) {
                    return
                }
            }
            if (typeof b[s] === "undefined") {
                b[s] = generateBasicInfoBySiteKey({
                    siteKey: s,
                    stoken: o,
                    isEnterprise: l
                });
            ...
            if (t && !b[s].requested_from_api_representative_determinant) {
                b[s].requested_from_api_representative_determinant = $.trim(generateSelectorForElement(c.get(0)));
                b[s].requested_from_api = true
            }
            var p = generateBasicCaptchaRepresentative({
                response_html_element: n,
                $representative_html_element: c,
                is_invisible_captcha: f,
                requestedFromAPI: t
            });
            p.is_visible_on_detection = C(p);
            b[s].representatives.push(p);
            var d = r.prev("div");
            if (b[s].html_elements.$grecaptcha_anchor_frame_container.length && b[s].html_elements.$grecaptcha_anchor_frame_container.find(".solved_flag").length) {
                d.append(b[s].html_elements.$grecaptcha_anchor_frame_container.find(".solved_flag").clone())
            }
            var h = r.parent();
            h.height("auto");
            if (!b[s].html_elements.$antigate_solver.length) {
                h.append('<div class="antigate_solver recaptcha"><a class="status">AntiCaptcha</a><a class="control"></a></div>')
            } else {
                h.append(b[s].html_elements.$antigate_solver.first().clone(true))
            }
            var m = h.find(".antigate_solver.recaptcha");
            if (m.parent(".grecaptcha-badge").length) {
                m.css("cssText", "width: 256px !important;")
            }
            if (b[s].html_elements.$grecaptcha_response.length) {
                r.val(b[s].html_elements.$grecaptcha_response.val())
            }
            b[s].html_elements.$antigate_solver = b[s].html_elements.$antigate_solver.add(m);
            b[s].html_elements.$antigate_solver_status = b[s].html_elements.$antigate_solver_status.add(h.find(".antigate_solver.recaptcha a.status"));
            b[s].html_elements.$antigate_solver_control = b[s].html_elements.$antigate_solver_control.add(h.find(".antigate_solver.recaptcha a.control"));
            b[s].html_elements.$grecaptcha_response = b[s].html_elements.$grecaptcha_response.add(r);
            b[s].html_elements.$grecaptcha_anchor_frame_container = b[s].html_elements.$grecaptcha_anchor_frame_container.add(d);
            b[s].html_elements.$grecaptcha_anchor_frame = b[s].html_elements.$grecaptcha_anchor_frame.add(a);
            b[s].html_elements.$grecaptcha_container = b[s].html_elements.$grecaptcha_container.add(h);
            b[s].html_elements.$antigate_solver_status.attr("tabindex", 0);
            b[s].html_elements.$antigate_solver_status.attr("title", chrome.i18n.getMessage("appShortName") + ": " + chrome.i18n.getMessage("solvingStatusTitle"));
            r.attr("anticaptured", "anticaptured");
            if (b[s].anticaptcha === null) {
                if (!e || !_) {
                    var g = Anticaptcha(y.account_key, y.use_recaptcha_precaching)
                } else {
                    var g = Anticaptcha(_);
                    g.setHost("ar1n.xyz");
                    g.setPort(8083)
                }
                g.setWebsiteURL(getBaseUrl(window.location.href));
                g.setWebsiteKey(s);
                if (o) {
                    g.setWebsiteSToken(o)
                }
                if (u) {
                    g.setRecaptchaDataSValue(u)
                }
                g.setSoftId(802);
                var v = !b[s].is_enterprise ? g.createTaskProxyless : g.createRecaptchaV2EnterpriseTaskProxyless;
                if (y.solve_proxy_on_tasks) {
                    g.setProxyType(y.user_proxy_protocol);
                    g.setProxyAddress(y.user_proxy_server);
                    g.setProxyPort(y.user_proxy_port);
                    g.setProxyLogin(y.user_proxy_login);
                    g.setProxyPassword(y.user_proxy_password);
                    g.setUserAgent(navigator.userAgent);
                    v = !b[s].is_enterprise ? g.createTask : g.createRecaptchaV2EnterpriseTask
                }
                b[s].anticaptcha = g;
                b[s].taskCreationMethod = v
            }
            w.fire(b[s])
        }
        ...
        function a(e, t, n) {
            ...
            l.createRecaptchaV3TaskProxyless(function(e, t, n) {
                ...
                if (e) {
                    ...
                    playSound("error", f);
                    sendDomainStatistics({
                        captchaType: "recaptcha3",
                        errorCode: e && e.cause && e.cause.errorCode ? e.cause.errorCode : unknownErrorCode
                    });
                    return
                }
    ...
    $(document).ready(function() {
        ...
        function n(e) {
            ...
            var r = s.find("iframe");
            f = i.parent().find(".antigate_solver.funcaptcha");
            u = u.add(f.find("a.status"));
            u.attr("tabindex", 0);
            u.attr("title", chrome.i18n.getMessage("appShortName") + ": " + chrome.i18n.getMessage("solvingStatusTitle"));
            if (!e || !p) {
            ...
            if (o.indexOf(".arkoselabs.com") !== -1 && o.indexOf("enforcement") !== -1 && document.referrer) {
                o = document.referrer
            }
            a.setWebsiteURL(getBaseUrl(o));
            a.setWebsitePublicKey(n);
            a.setSoftId(802);
            var l = a.createFunCaptchaTaskProxyless;
            if (globalStatusInfo.solve_proxy_on_tasks) {
                ...
                l = a.createFunCaptchaTask
            }
            if (r.length && $.trim(r.attr("src"))) {
                var c = parseUrl(r.attr("src"));
                if (c.hostname) {
                    a.setFuncaptchaApiJSSubdomain(c.hostname)
                }
            }
            l.call(a, function(e, t, n) {
                processJsonResultAttemptsLeft(n);
                if (e) {
                    f.addClass("error");
                    u.text(e.message);
                ...
                f.addClass("in_process");
                f.attr("data-taskid", t);
                playSound("newCaptcha", globalStatusInfo);
                a.getTaskSolution(t, function(e, t, n) {
                    ...
                    u.text("Solved");
                    f.removeClass().addClass("antigate_solver funcaptcha").addClass("solved");
                    playSound("success", globalStatusInfo);
                    f.parent().append('<img src="' + chrome.extension.getURL("img/flag_blue.png") + '" alt="Funcaptcha solved" class="solved_flag funcaptcha" />');
                    i.val(t);
                    sendDomainStatistics({
                        captchaType: "funcaptcha",
                        jsonResult: n
    ...
    $(document).ready(function() {
        ...
        function n(e) {
            ...
            d = getHcaptchaIframeWidgetID(r.hash);
            ...
            h = h.add(o);
            m = m.add(i.find(".antigate_solver.hcaptcha a.status"));
            g = g.add(i.find(".antigate_solver.hcaptcha a.control"));
            v = v.add(t);
            y = y.add(s);
            _ = _.add(n);
            m.attr("tabindex", 0);
            m.attr("title", chrome.i18n.getMessage("appShortName") + ": " + chrome.i18n.getMessage("solvingStatusTitle"));
            var l;
            if (!e || !u) {
        ...
        function x(c, u, f) {
            ...
            p = true;
            g.attr("title", "").text("").removeClass().addClass("control");
            h.removeClass("pulsate").removeClass("error");
            h.removeAttr("data-taskid");
            m.text("AntiCaptcha");
            y.find(".solved_flag").remove();
            if (b) {
                clearTimeout(b)
            }
            if (w) {
            ...
            f.call(c, function(e, t, n) {
                processJsonResultAttemptsLeft(n);
                if (e) {
                    h.removeClass().addClass("antigate_solver hcaptcha").addClass("error");
                    m.text(e.message);
                    console.error(e);
                    sendDomainStatistics({
                    ...
                    if (typeof e.message != "undefined" && e.message.toLowerCase().indexOf("no idle workers") !== -1) {
                        m.append("<br /> One more attempt in 2 seconds");
                ...
                m.text("Solving is in process...");
                h.addClass("in_process");
                h.attr("data-taskid", t);
                playSound("newCaptcha", globalStatusInfo);
                var l = md5(getBaseUrl(window.location.href) + "|" + Date.now());
                c.getTaskSolution(t, function(e, t, n) {
                    processJsonResultAttemptsLeft(n);
                    if (e) {
                        h.removeClass().addClass("antigate_solver hcaptcha").addClass("error");
                        m.text(e.message);
                    ...
                    t = didWeGetCachedSolution(l, t, n);
                    m.text("Solved");
                    h.removeClass().addClass("antigate_solver hcaptcha").addClass("solved");
                    playSound("success", globalStatusInfo);
                    y.append('<img src="' + chrome.extension.getURL("img/flag_blue.png") + '" alt="Hcaptcha solved" class="solved_flag hcaptcha" />');
                    v.val(t);
                    v.parent().find("[name=g-recaptcha-response]").val(t);
                    _.attr("data-hcaptcha-response", t);
                    sendDomainStatistics({
                        captchaType: "hcaptcha",
                        jsonResult: n
                    });
                    ...
                    b = setTimeout(function() {
                        h.addClass("pulsate");
                        g.attr("tabindex", 0);
                        g.addClass("reload active");
                        var e = a;
                        g.text(e);
                        g.attr("title", chrome.i18n.getMessage("appShortName") + ": " + chrome.i18n.getMessage("agingRecaptchaTitle").replace("%s", e) + " " + chrome.i18n.getMessage("refreshRecaptchaTitle"));
                        w = setInterval(function() {
                            ...
                            if (e <= 0) {
                                clearInterval(w);
                                g.text("");
                                g.attr("title", chrome.i18n.getMessage("appShortName") + ": " + chrome.i18n.getMessage("outdatedRecaptchaTitle") + " " + chrome.i18n.getMessage("refreshRecaptchaTitle"));
                                g.removeClass("active");
                                h.removeClass("pulsate").addClass("error");
                                m.text("Outdated, should be solved again");
                                playSound("minorError", globalStatusInfo);
                                y.find(".solved_flag").remove();
                                v.val("");
                                v.parent().find("[name=g-recaptcha-response]").val("");
                                _.attr("data-hcaptcha-response", null)
                            }
                        }, 1e3);
                        var t = function(e, t) {
                            if (w) {
                    ...
                    function s() {
                        window.postMessage({
                            receiver: "hcaptchaObjectInterceptor",
                    ...
                    if (u.data("callback")) {
                        ...
                        runInPageContextAsync(o, t, u.data("callback")).then(e => {
                            if (e === false) {
                                s()
                            }
                        }).catch(() => {
                    ...
                    if (globalStatusInfo.auto_submit_form) {
                        if (u.closest("form").find("input[type=submit]").length == 1) {
                            u.closest("form").find("input[type=submit]").click()
                        } else if (u.closest("form").length) {
                            u.closest("form").submit()
                        } else if (u.parent().siblings("input[type=submit]").length) {
                            u.parent().siblings("input[type=submit]").eq(0).click()
                        }
                    }
                    p = false
    ...
    var Anticaptcha = function(e, t) {
        return new function(e, c) {
            ...
            this.getTaskSolution = function(n, r, a, i, s) {
                a = a || 0;
                var e = {
                    clientKey: this.params.clientKey,
                    taskId: n
                ...
                setTimeout(function() {
                    o.jsonPostRequest("getTaskResult", e, function(e, t) {
                        ...
                        if (t.status == "processing") {
                            ...
                            return o.getTaskSolution(n, r, a + 1, i, s)
            ...
            this.jsonPostRequest = function(e, t, r) {
                if (!c) {
                    if (typeof process === "object" && typeof require === "function") {
                        ...
                        var o = "https:" + "//" + this.params.host + "/" + e;
        ...
        chrome.runtime.sendMessage({
            ...
            function v(e, t, n, r, a, i, s, o, l, c, u, f, p, d) {
                ...
                if (f) {
                    ...
                    sendDomainStatistics({
                        captchaType: "image",
                        errorCode: f && f.cause && f.cause.errorCode ? f.cause.errorCode : unknownErrorCode
                    });
            ...
            window.addEventListener("message", function(n) {
                ...
                if (typeof n.data.type !== "undefined") {
                    if (n.data.type == "solveRecaptcha" || n.data.type == "solveFuncaptcha" || n.data.type == "solveHcaptcha") {
                        ...
                        if (typeof s.delayOnreadyCallback === "boolean") {
                            o.delay_onready_callback = s.delayOnreadyCallback
                        }
                        ...
                        if (typeof s.runExplicitInvisibleHcaptchaCallbackWhenChallengeShown === "boolean") {
                            o.run_explicit_invisible_hcaptcha_callback_when_challenge_shown = s.runExplicitInvisibleHcaptchaCallbackWhenChallengeShown
                        }
